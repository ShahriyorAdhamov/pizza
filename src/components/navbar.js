    ...
    <div className='navbar'>
      <Link to = '/'>
        <div className='navbar__left'>
          <img className='logo' src="https://www.shutterstock.com/shutterstock/photos/1881274942/display_1500/stock-vector-pizza-logo-creative-pizza-logo-design-1881274942.jpg" alt="logo" />
        </div>
      </Link>


      <div className='navbar__middle'>
          <input placeholder='search...' type="search" className='search-input'    onChange={e => setSearchTxt(e.target.value)} value={searchTxt}/>
      </div>
